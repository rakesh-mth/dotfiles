...
If you are unsure, try setting them in `dotspacemacs/user-config' first."
  ...
  (setq-default dotspacemacs-default-font '("MesloLGS NF"
                                            :size 24.0
                                            :weight normal
                                            :width normal
                                            :powerline-scale 1.1))
