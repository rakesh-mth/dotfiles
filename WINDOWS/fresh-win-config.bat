...
#admin powershell
choco install -y neovim emacs vim fd ripgrep ag fzf bat ctags wget 7zip git gitversion.portable cmake powershell-core python2 python3 groovy nodejs ruby jdk8 dotnetcore dotnetcore-sdk golang lua53 rustup.install llvm hunspell.portable nuget.commandline jfrog-cli gotomeeting lxrunoffline libreoffice-fresh rufus nasm yasm
