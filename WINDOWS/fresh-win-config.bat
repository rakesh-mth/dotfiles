...
#admin powershell
choco install -y neovim emacs vim fd ripgrep ag fzf ctags wget 7zip git gitversion.portable cmake powershell-core python2 python3 groovy nodejs ruby jdk8 golang rust llvm hunspell.portable nuget.commandline jfrog-cli gotomeeting lxrunoffline libreoffice-fresh
